...
#ifndef BMPFILE_INC_H
#define  BMPFILE_INC_H
...
Image* readBMPFile_teacher(char * nomFichier, int verbose);
...
void writeBMPFile_teacher(char * nomFichier, Image* image, int verbose);
